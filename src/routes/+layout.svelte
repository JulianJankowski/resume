...
<nav class="relative flex items-center justify-between flex-wrap bg-transparent p-6 data-twe-navbar-ref">
    ...
    <div 
        ...
        id="smallNav">
        <a href="{base}/Examples" class="block mt-4 lg:inline-block text-xl lg:mt-0 text-white transition-all duration-200 ease-in-out hover:text-teal-300 mr-4">
            Examples
        </a>
        <a href="{base}/Socials" class="block mt-4 lg:inline-block text-xl lg:mt-0 text-white transition-all duration-200 ease-in-out hover:text-teal-300">
            Socials
        </a>
        <div class="absolute lg:right-20 max-lg:pt-5">
            <a href='https://www.github.com/JulianJankowski'><button class="bg-background-white hover:text-teal-200 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
            ...
            <a href='https://www.linkedin.com/in/julian-jankowski-b1636b151/'><button class="bg-background-grey hover:text-teal-200 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
